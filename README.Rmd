...
Approximate Bayesian pooling (ABpool) approximates the observed-data posterior distribution after multiple imputation. For the $l$th imputed dataset, let the completed-data estimate and associated variance be given by
```math
