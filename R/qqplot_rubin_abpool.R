...
#' \[
#' \bar{theta} = \operatorname{mean}(\text{estimates})
#' \]
#' and squared scale
#' \[
#' V = \operatorname{mean}(\text{variances})
#'       + \left(1 + \frac{1}{m}\right)
#'         \operatorname{variance}(\text{estimates}).
#' \]
#' The degrees of freedom are calculated
#' using the Barnard--Rubin method, which simplifies to Rubin's original method
#' when the complete-data degrees of freedom are infinite.
#'
...
#'
#' @references
#' Phillips DJ, Christodoulou MD and Steinsaltz D. (XXXX)
#'
...
#'
#' @seealso
#' [abpool()], [qqplot()], [ppoints()], [mice::pool()], [mice::barnard.rubin()]
#'
#' @examples
